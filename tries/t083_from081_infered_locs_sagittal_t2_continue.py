...
class Model(nn.Module):
    def __init__(self):
        ...
        self.seg_mask_head = nn.Conv3d(decoder_channels[-1], 15, kernel_size=1)
...
def main(): 
    ...
    #df = get_df_series()
    df = pd.read_csv('/media/workspace/RSNA2024_input/rsna-2024-lumbar-spine-degenerative-classification/t0917get_coors_sagittal_t2_df_series.csv')
    ...
    save_weights = []
    for fold_n in range(3, config['folds']):
