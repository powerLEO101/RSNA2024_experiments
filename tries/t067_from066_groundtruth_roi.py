    ...
    def __getitem__(self, index):
        ...
        for level in range(5):
            for condition in conditions:
                ...
                x = int(x * 384)
                y = int(y * 384)
                select_image.append(image[:, instance_number, x - 48 : x + 48, y - 48 : y + 48])
        ...
        rand_number = np.random.randint(2, 5)
        select_image = select_image[rand_number]
        label = label[rand_number]
